...
execute if predicate {"type":"minecraft:random_chance","chance":0.25} as @e[type=minecraft:item_display,tag=nice_things.fan.display,y_rotation=-180] at @s run particle dust{color:[0.800,0.800,0.800],scale:.75} ~ ~.5 ~-.5 .1 .1 .5 0 2 normal
execute if predicate {"type":"minecraft:random_chance","chance":0.25} as @e[type=minecraft:item_display,tag=nice_things.fan.display,y_rotation=-90] at @s run particle dust{color:[0.800,0.800,0.800],scale:.75} ~.5 ~.5 ~ -.5 .1 .1 0 2 normal
execute if predicate {"type":"minecraft:random_chance","chance":0.25} as @e[type=minecraft:item_display,tag=nice_things.fan.display,y_rotation=90] at @s run particle dust{color:[0.800,0.800,0.800],scale:.75} ~-.5 ~.5 ~ .5 .1 .1 0 2 normal
execute if predicate {"type":"minecraft:random_chance","chance":0.25} as @e[type=minecraft:item_display,tag=nice_things.fan.display,y_rotation=0] at @s run particle dust{color:[0.800,0.800,0.800],scale:.75} ~ ~.5 ~.5 .1 .1 -.5 0 2 normal