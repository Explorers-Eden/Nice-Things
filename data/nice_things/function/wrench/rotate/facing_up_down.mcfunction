...
$execute if block ~ ~ ~ $(block)[facing=west] run return run setblock ~ ~ ~ $(block)[facing=down]
$execute if block ~ ~ ~ $(block)[facing=down] run return run setblock ~ ~ ~ $(block)[facing=up]
$execute if block ~ ~ ~ $(block)[facing=up] run return run setblock ~ ~ ~ $(block)[facing=north]